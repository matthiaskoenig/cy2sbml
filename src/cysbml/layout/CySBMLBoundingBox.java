...
public class CySBMLBoundingBox {
	...
	public CySBMLBoundingBox(String id, double x, double y){
		nodeId = id;
		xpos = x;
		ypos = y;
	...
	public CySBMLBoundingBox(String id, double x, double y, double h, double w){
		nodeId = id;
		xpos = x;
		ypos = y;
		height = h;
